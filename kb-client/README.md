...
| `case-fetch.py` | Read commands — `case` / `journey` / `list` / `fireside` / `library` / `edges` / `flags` / `read <TYPE>` (generic typed read, symmetric to the write path) — over the gateway (CASE-393/479/482/518/630/683). |
